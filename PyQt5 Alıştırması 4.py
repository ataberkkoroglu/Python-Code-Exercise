...
class Pencere(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.yazı_alanı=QtWidgets.QLabel(self.windows)
        self.windows.setWindowTitle("Software")
